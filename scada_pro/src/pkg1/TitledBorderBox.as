package pkg1
{
	...
	public class TitledBorderBox extends Container implements IConstraintLayout, IFontContextComponent
	{
		...
		private static function classConstruct():Boolean {
			...
			var style:CSSStyleDeclaration = FlexGlobals.topLevelApplication.styleManager.getStyleDeclaration("TitledBorderBox");
			if (!style) {
			...
			FlexGlobals.topLevelApplication.styleManager.setStyleDeclaration("TitledBorderBox", style, true);     
			return true;
		};
