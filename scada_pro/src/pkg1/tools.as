...
//		public function tools(width:Number, height:Number)
//		{
...
//		}
		...
		public function tools(imgWidth:Number, imgHeight:Number, localPt1:Point, localPt2:Point, geoPt1:Point, geoPt2:Point)
		{
			this._panzoomWidth = imgWidth;
			this._panzoomHeight = imgHeight;
			
			var localWidth:Number = (localPt1.x > localPt2.x) ? localPt1.x - localPt2.x :  localPt2.x - localPt1.x;
			var localHeight:Number = (localPt1.y > localPt2.y) ? localPt1.y - localPt2.y :  localPt2.y - localPt1.y;
			
			var geoWidth:Number = (geoPt1.x > geoPt2.x) ? geoPt1.x - geoPt2.x :  geoPt2.x - geoPt1.x;
			var geoHeight:Number = (geoPt1.y > geoPt2.y) ? geoPt1.y - geoPt2.y :  geoPt2.y - geoPt1.y;
			
			
			Utils.offSetX = geoWidth / localWidth;
			Utils.offSetY = geoHeight / localHeight;
			
			Utils.baseGeoPt = new Point(geoPt1.x - (localPt1.x * Utils.offSetX), geoPt1.y + (localPt1.y * Utils.offSetY));
		}
